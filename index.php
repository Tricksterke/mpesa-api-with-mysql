...
$tillNumber = 'YOUR_TILL_NUMBER';         // Replace with your till number
    ...
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
      ...
      <form id="stkForm" class="space-y-4">
        <div>
          ...
          <input type="text" id="phone" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="2547XXXXXXXX" maxlength="12" required>
        </div>
        <div>
          <label for="amount" class="block text-gray-600 font-medium mb-1">Amount</label>
          <input type="number" id="amount" class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter amount" required>
        </div>
        <button type="submit" class="w-full bg-green-600 text-white py-2 px-4 rounded hover:bg-green-700 transition"> Make Payment </button>
      </form>
      <!-- Loader -->
